	...
	<div class="container py-md-3">
		...
		<c:forEach items="${list}" var="board">
			...
			<div class="col-lg-5 mb-lg-5 mb-4">
				...
				<h4 class="my-3"><a class='move' href='<c:out value="${board.bno}"/>'><c:out value="${board.title}" /></h4>
			...
			<div class="col-lg-7 mb-5 blog-img2">
				<img src="${pageContext.request.contextPath}/resources/images/blog2.jpg" alt="" class="img-fluid" onerror="javascript:src={${pageContext.request.contextPath}/resources/images/blog1.jpg}"/>
				<a href="single.JSP">Blog #2</a>
			</div>
			<div class="col-lg-7 mb-lg-5 blog-img1">
				<img src="${pageContext.request.contextPath}/resources/images/blog1.jpg" alt="" class="img-fluid" onerror="javascript:src={${pageContext.request.contextPath}/resources/images/blog1.jpg}"/>
				<a href="single.JSP">Blog #3</a>
			</div>
			<div class="col-lg-5 mb-lg-5 mb-4">
				<h5>March 3, 2019.</h5>
				<h4 class="my-3">Nullam dui mi, vulputate ac</h4>
			...
			<div class="col-lg-7 mb-5 blog-img2">
				<img src="${pageContext.request.contextPath}/resources/images/blog2.jpg" alt="" class="img-fluid" onerror="javascript:src={${pageContext.request.contextPath}/resources/images/blog1.jpg}"/>
				<a href="single.JSP">Blog #4</a>
			</div>
			<div class="col-lg-7 mb-lg-5 blog-img1">
				<img src="${pageContext.request.contextPath}/resources/images/blog1.jpg" alt="" class="img-fluid" onerror="javascript:src={${pageContext.request.contextPath}/resources/images/blog1.jpg}"/>
				<a href="single.JSP">Blog #5</a>
			</div>
			<div class="col-lg-5 mb-lg-5 mb-4">
				<h5>March 3, 2019.</h5>
				<h4 class="my-3">Nullam dui mi, vulputate ac</h4>
